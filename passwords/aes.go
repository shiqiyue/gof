...
// 这儿只是个私钥的例子，请不要用这儿的私钥
var privateKey = []byte("asdf$%^123123adf")
...
//将加密的结果进行base64编码
func AesEncryptBase64(pwd, privateKey []byte) (string, error) {
	//进行aes加密
...
//base64解码
func AesDeCryptBase64(pwd string, privateKey []byte) ([]byte, error) {
	//解码base64字符串
