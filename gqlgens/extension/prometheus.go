...
func (a Prome) ExtensionName() string {
	return "Prometheus"
}

func (a Prome) Validate(schema graphql.ExecutableSchema) error {
	return nil
}

func (a Prome) InterceptOperation(ctx context.Context, next graphql.OperationHandler) graphql.ResponseHandler {
	requestStartedCounter.Inc()
	return next(ctx)
}

func (a Prome) InterceptResponse(ctx context.Context, next graphql.ResponseHandler) *graphql.Response {
...
func (a Prome) InterceptField(ctx context.Context, next graphql.Resolver) (interface{}, error) {
